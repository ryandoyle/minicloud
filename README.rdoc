...
Humm, nothing. We need to register one
  $ mcc-add-key --name my-key --public-key "ssh-rsa AAAAB3NzaC1yc2.....aQ== mykey"

Now let's launch an instance!
  $ mcc-run-instances -i centos-5-x86_64 -t basic -k doylenet
            ID   IP
      INST  501  10.0.0.110
...
progress using mcc-list-instances
  $ mcc-list-instances 
               ID   IP          STATUS   TEMPLATE
      INSTANCE 501  10.0.0.110  running  centos-5-x86_64
...
Copyright (c) 2011 {Ryan Doyle}[http://ryandoyle.net]
